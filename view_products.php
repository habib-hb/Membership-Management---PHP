        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>{$currencySymbol} {$row['price']}</td>";
                    echo "<td>
                            <a href='edit_product.php?id={$row['id']}' class='btn btn-primary'><i class='fas fa-edit'></i> Edit</a>
                            <button class='btn btn-danger' onclick='deleteProduct({$row['id']})'><i class='fas fa-trash'></i> Delete</button>
                          </td>";
                    echo "</tr>";
                    $counter++;
